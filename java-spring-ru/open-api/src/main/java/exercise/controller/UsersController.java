...
public class UsersController {
    ...
    @ApiResponses(value= {
            ...
            @ApiResponse(responseCode = "404", description = "There is not user with such id")
    })
    @PatchMapping(path = "/{id}")
    public User updateUser(@Parameter(description = "id of user witch we want to update")
                               @PathVariable long id,
                           @Parameter(description = "new information about this user")
