...
public class AppTest {
    ...
    void testGetPeople() throws Exception {
        ...
        assertThat(response.getContentType()).contains(MediaType.APPLICATION_JSON.toString());
    ...
    // BEGIN
    @Test
    void checkCurrentEntity() throws Exception {
        MockHttpServletResponse response = mockMvc
    ...
    void checkUpdatingEntity() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(patch("/people/2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\": \"Mikhail\", \"lastName\": \"Krylov\"}"))
                .andReturn()
                .getResponse();
        ...
        MockHttpServletResponse response = mockMvc
                ...
                .andReturn()
                .getResponse();
        assertThat(response.getContentAsString()).contains("Mikhail", "Krylov");
